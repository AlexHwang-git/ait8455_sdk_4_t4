...
typedef enum {
	ISP_CALI_MODE_MANUAL_0			= 0,
	ISP_CALI_MODE_MANUAL_1			= 1,
	ISP_CALI_MODE_MANUAL_2			= 2,
	ISP_CALI_MODE_MANUAL_3			= 3,
	ISP_CALI_MODE_MANUAL_4			= 4,
	ISP_CALI_MODE_MANUAL_5			= 5,
	ISP_CALI_MODE_MANUAL_6			= 6,
	ISP_CALI_MODE_MANUAL_7			= 7,
	ISP_CALI_MODE_MANUAL_8			= 8,
	ISP_CALI_MODE_MANUAL_9			= 9,
	ISP_CALI_MODE_AUTO				= 0xFF
} ISP_CALI_MODE;
...
typedef enum {
	...
	ISP_SCENE_MANUAL0				= 19,	// scene mode
	ISP_SCENE_MANUAL1				= 20,	// scene mode
	ISP_SCENE_MANUAL2				= 21,	// scene mode
	ISP_SCENE_MANUAL3				= 22,	// scene mode
	ISP_SCENE_MANUAL4				= 23,	// scene mode
	ISP_SCENE_MANUAL5				= 24,	// scene mode
	ISP_SCENE_MANUAL6				= 25,	// scene mode
	ISP_SCENE_MANUAL7				= 26,	// scene mode
	ISP_SCENE_MANUAL8				= 27,	// scene mode
	ISP_SCENE_MANUAL9				= 28	// scene mode
} ISP_SCENE;

typedef enum {
	ISP_SCENE_ITEM_ISO				= 0,
	ISP_SCENE_ITEM_MINFPS			= 1,
	ISP_SCENE_ITEM_AWB_MODE			= 2,
	ISP_SCENE_ITEM_AE_METER			= 3,
	ISP_SCENE_ITEM_EV_BIAS			= 4,
	ISP_SCENE_ITEM_FACE_DECT		= 5,
	ISP_SCENE_ITEM_AF_MODE			= 6,
	ISP_SCENE_ITEM_IMG_EFT			= 7,
	ISP_SCENE_ITEM_CONTRAST			= 8,
	ISP_SCENE_ITEM_SHARPNESS		= 9,
	ISP_SCENE_ITEM_SATURATION		= 10,
	ISP_SCENE_ITEM_FLICKER			= 11,
	ISP_SCENE_ITEM_WDR				= 12,
	ISP_SCENE_ITEM_MINFPS_VIDEO		= 13,
	ISP_SCENE_ITEM_NUM				= 14
} ISP_SCENE_ITEM;
...
void ISP_IF_AE_SetMinAccLength(ISP_UINT32 min_lengthx, ISP_UINT32 min_lengthy);
void ISP_IF_AE_SetDZTol(ISP_UINT32 up_tol, ISP_UINT32 low_tol);
...
ISP_UINT8 ISP_IF_AWB_GetFastMode(void);
...
void ISP_IF_AWB_SetDefaultGain(ISP_UINT16 gain_Rx128, ISP_UINT16 gain_Bx128);
...
void ISP_IF_CALI_SetLS_Ratio(ISP_UINT8 index, ISP_UINT16 ratio_r, ISP_UINT16 ratio_g, ISP_UINT16 ratio_b);
...
void ISP_IF_CALI_SetOZLSOffset(ISP_UINT8 index);
void ISP_IF_CALI_SetOZCSOffset(ISP_UINT8 index);
