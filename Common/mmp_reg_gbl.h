...
typedef struct _AITS_GBL {
	...
	AIT_REG_B	GBL_SOFT_RESOL_SEL;							//0x20
		#define	GBL_SENSOR_3M			0x00F3
		#define	GBL_SENSOR_5M			0x00F5
		#define	GBL_SENSOR_8M			0x00F8
	...
	AIT_REG_B	GBL_IO_CTL0;								//0x25
		/*-DEFINE-----------------------------------------------------*/
		#if (CHIP == VSN_V3)
		#define GBL_VIF1_PAD0				0x10
		#define GBL_VIF1_PAD1				0x20
		#define GBL_VIF1_PAD2				0x30
		#define GBL_VIF1_BASE				0x30
	...
	AIT_REG_B	GBL_IO_CTL1;								//0x26
        ...
        #define GBL_SPI_PAD_EN              0x04 // PB0~PB3
	...
	AIT_REG_B	GBL_IO_CTL2;								//0x27
		/*-DEFINE-----------------------------------------------------*/
		#define GBL_PWM0_2_PA_GPIO0			0x01
		#define GBL_PWM1_2_PSNR_D8			0x02
		#define GBL_PWM2_2_PSNR_D9			0x04
		#define GBL_PWM3_2_PA_GPIO6			0x08
		#define GBL_PWM1_2_PB_GPIO11		0x20
		#define GBL_PWM2_2_PB_GPIO13		0x40
		#define GBL_PWM3_2_PSNR_RST_N		0x80
		/*------------------------------------------------------------*/
	AIT_REG_B	GBL_IO_CTL3;								//0x28
		...
		#define GBL_PSPI_IO_PAD0_EN         0x10
	...
	AIT_REG_B	GBL_IO_CFG_PSNR2[0x3];						//0xCA~0xCE
