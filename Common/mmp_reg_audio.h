...
typedef struct _AITS_AFE {
	...
	AIT_REG_B	AFE_ADC_RCH_PGA_GAIN_CTL;							// 0x69
		/*-DEFINE-----------------------------------------------------*/
		#define AFE_ADC_0DB             0x0B
		#define AFE_ADC2PGA(reg)        (MMP_BYTE)( (MMP_UBYTE)reg  - AFE_ADC_0DB)
		#define AFE_PGA2ADC(gain)       (MMP_BYTE)( (MMP_BYTE)gain  + AFE_ADC_0DB)         
		/*------------------------------------------------------------*/
	...
	AIT_REG_B	AFE_ADC_CTL_REG4;									// 0x74
		...
		#define ADC_MIC_BIAS_VOLTAGE115AVDD     0x03
		#define ADC_MIC_BIAS_VOLTAGE095AVDD     0x02
