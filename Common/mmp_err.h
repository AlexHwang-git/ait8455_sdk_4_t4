...
typedef enum _MMP_ERR
{
	...
	MMP_MP4VE_ERR_NOT_SUPPORTED_BITSTREAM,
	MMP_MP4VE_ERR_FRM_WORKBUF_SET_FULL,
	MMP_MP4VE_ERR_FRM_WORKBUF_SET_OVERFLOW,
	MMP_MP4VE_ERR_FRM_WORKBUF_SET_UNDERFLOW,
