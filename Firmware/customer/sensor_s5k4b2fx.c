...
//#include "motor_ctl.h"
//------------------------------------------------------------------------------
//  Function    : S5K4B2FX_Sensor_PreviewMode
//  Description :
//------------------------------------------------------------------------------
static void S5K4B2FX_Sensor_SetResolution(ISP_SENSOR_RESOL resol)	// Patrick add
{
...
static void S5K4B2FX_Sensor_PreviewMode(MMP_USHORT usPreviewmode, MMP_USHORT usPhasecount)
{
    ...
    case 0:
		...
		S5K4B2FX_Sensor_SetResolution(ISP_SENSOR_RESOL_1280x720);
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_Initialize_S5K4B2FX(void)
{
//  MMP_USHORT usData;
    ...
    RTNA_DBG_Str(0, "MMPF_Sensor_Initialize_S5K4B2FX...Begin\r\n");
    ...
    gsSensorLCModeWidth     = 1600;
    gsSensorLCModeHeight    = 900;
    // use 1.3M for preview, check sensor preview setting
    gsSensorMCModeWidth     = 1600;
    gsSensorMCModeHeight    = 900;
#else
    //Init globol variable used by DSC
    gsSensorLCModeWidth     = 1600;
    gsSensorLCModeHeight    = 1200;
    // use 1.3M for preview, check sensor preview setting
    gsSensorMCModeWidth     = 1600;
...
//    pGPIO->GPIO_DATA[0] &= ~(1 << AF_EN);  // Turn On Motor
    ...
    RTNA_DBG_Str(3, "MMPF_Sensor_Initialize_S5K4B2FX...End\r\n");
    return  MMP_ERR_NONE;
}

//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_PowerDown_S5K4B2FX
//  Description :
//------------------------------------------------------------------------------

static MMP_ERR  MMPF_Sensor_PowerDown_S5K4B2FX(void)
{
    AITPS_VIF  pVIF = AITC_BASE_VIF;
    AITPS_GPIO  pGPIO = AITC_BASE_GPIO;
    ...
    RTNA_DBG_Str3( "MMPF_Sensor_PowerDown_S5K4B2FX() \r\n");

    return  MMP_ERR_NONE;
}

//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_SetFrameRate_S5K4B2FX
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_SetFrameRate_S5K4B2FX(MMP_UBYTE ubFrameRate)
{
    return  MMP_ERR_NONE;
}
...
static MMP_ERR MMPF_Sensor_SetPreviewMode_S5K4B2FX(MMP_USHORT usPreviewmode, MMP_USHORT usPhasecount)
{
    S5K4B2FX_Sensor_PreviewMode(usPreviewmode, usPhasecount);
...
static MMP_ERR MMPF_Sensor_ChangePreviewMode_S5K4B2FX(
                        MMP_USHORT usCurPreviewmode, MMP_USHORT usCurPhasecount,
                        MMP_USHORT usNewPreviewmode, MMP_USHORT usNewPhasecount)
{
    S5K4B2FX_Sensor_PreviewMode(usNewPreviewmode, usNewPhasecount);
...
static MMP_ERR MMPF_Sensor_ChangeMode_S5K4B2FX(MMP_USHORT usPreviewmode, MMP_USHORT usCapturemode)
{
    switch (usPreviewmode) {
    case 0:
    ...
    case 1:
        ...
        case 0:// SXGA preview, 5M capture
            MMPF_Sensor_SetPreviewMode_S5K4B2FX(0, 0);
            // wait 3 frame ...
            MMPF_Sensor_WaitFrame(5);
            break;
        case 1:
            MMPF_Sensor_SetPreviewMode_S5K4B2FX(1, 0);
            // wait 3 frame ...
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_InitializeVIF_S5K4B2FX(void)
{
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_InitializeISP_S5K4B2FX(void)
{
    return  MMP_ERR_NONE;
}
...
//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_SetAFPosition_S5K4B2FX
//  Description :
// ---------------------------------------
static MMP_ERR MMPF_Sensor_SetAFPosition_S5K4B2FX(MMP_UBYTE ubPos)
{
#if 1
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_Do3AOperation_S5K4B2FX(void)
{
	ISP_IF_R_GetAEAcc();
	ISP_IF_R_GetAWBAcc();
    ...
    //RTNA_DBG_Str(0, "Do3AOperation_S5K4B2FX()\r\n");
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_DoAFOperation_S5K4B2FX(void)
{
#if SUPPORT_AUTO_FOCUS
...
//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_DoIQOperation_S5K4B2FX
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_DoIQOperation_S5K4B2FX(void)
{
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_SetLightFreq_S5K4B2FX(MMP_USHORT usMode)
{
...
static MMP_ERR  MMPF_SetStableState_S5K4B2FX(MMP_BOOL bStableState)
{
    return  MMP_ERR_NONE;
}

MMP_ERR MMPF_SetHistEQState_S5K4B2FX(MMP_BOOL bHistEQState)
{

    return  MMP_ERR_NONE;
}

static MMP_ERR  MMPF_Sensor_SetReg_S5K4B2FX(MMP_USHORT usAddr, MMP_USHORT usData)
{
    MMPF_I2cm_WriteReg(usAddr, usData);
    return  MMP_ERR_NONE;
}

static MMP_ERR  MMPF_Sensor_GetReg_S5K4B2FX(MMP_USHORT usAddr, MMP_USHORT *usData)
{
...
static MMP_ERR  MMPF_Sensor_SetImageScene_S5K4B2FX(MMP_USHORT imgSceneID)
{
/*
typedef enum {
...
*/
	...
	RTNA_DBG_Str(3, "MMPF_SetImageScene_S5K4B2FX : ");
...
static MMP_ERR  MMPF_Sensor_SetAEMode_S5K4B2FX(MMP_UBYTE ubAEMode, MMP_UBYTE ubISOMode)
{
/*
typedef enum {
	AE_MODE_AUTO						= 0,
...
*/
	RTNA_DBG_Str(3, "MMPF_Sensor_SetAEMode_S5K4B2FX : ");
...
static MMP_ERR  MMPF_Sensor_SetAFMode_S5K4B2FX(MMP_UBYTE ubAFMode)
{
/*
typedef enum {
...
*/
	RTNA_DBG_Str(3, "MMPF_Sensor_SetAFMode_S5K4B2FX : ");
...
// description :                                                        //
//======================================================================//
static MMP_ERR  MMPF_Sensor_SetImageEffect_S5K4B2FX(MMP_USHORT imgEffectID)
{
/*
typedef enum {
...
*/
	...
	RTNA_DBG_Str(3, "MMPF_Sensor_SetImageEffect_S5K4B2FX : ");
...
static MMP_ERR  MMPF_Sensor_SetAWBType_S5K4B2FX(MMP_UBYTE ubType)
{
#if 0
	RTNA_DBG_Str(3, "MMPF_Sensor_SetAWBType_S5K4B2FX : ");
...
static MMP_ERR  MMPF_Sensor_SetContrast_S5K4B2FX(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_Contrast_S5K4B2FX : ");
...
static MMP_ERR  MMPF_Sensor_SetSaturation_S5K4B2FX(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetSaturation_S5K4B2FX : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetSharpness_S5K4B2FX(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetSharpness_S5K4B2FX : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetHue_S5K4B2FX(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetHue_S5K4B2FX : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetGamma_S5K4B2FX(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetGamma_S5K4B2FX : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetBacklight_S5K4B2FX(MMP_UBYTE ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetBacklight_S5K4B2FX : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static void  MMPF_Sensor_SetCaptureISPSetting_S5K4B2FX(MMP_UBYTE usCaptureBegin)
{
    AITPS_VIF  pVIF = AITC_BASE_VIF;
...
static void  MMPF_Sensor_SetISPWindow_S5K4B2FX(MMP_ULONG ulWidth, MMP_ULONG ulHeight)
{
...
static MMP_UBYTE  MMPF_Sensor_CheckPreviewAbility_S5K4B2FX(MMP_USHORT usPreviewmode)
{
    switch(usPreviewmode){
...
static void SetAFWin_S5K4B2FX(MMP_USHORT usIndex, MMP_USHORT usPreviewWidth, MMP_USHORT usPreviewHeight,
...
static void SetAFEnable_S5K4B2FX(MMP_UBYTE enable)
{
//    if (enable) {
        RTNA_DBG_Str(3, "VENUS_ISP_AUTO_FOCUS_STATUS_START\r\n");
        ISP_IF_AF_Control(ISP_AF_START);
        //actually calling SNR_S5K4B2FX_SetAutoFocusControl()
//    } else {
...
static MMP_ERR MMPF_Sensor_SetAEEnable_S5K4B2FX(MMP_UBYTE bEnable)  
{
	/*
	if (bEnable) {
...
static MMP_ERR MMPF_Sensor_SetAWBEnable_S5K4B2FX(MMP_UBYTE bEnable) 
{
#if 0
	if (bEnable) {
...
static void SetAEsmooth_S5K4B2FX(MMP_UBYTE smooth)  {return;}
static MMP_ERR MMPF_Sensor_SetExposureValue_S5K4B2FX(MMP_UBYTE ev)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetExposureValue_S5K4B2FX : ");
...
static MMP_UBYTE GetAFPosition_S5K4B2FX     (void){ return 0;/*volatile MMP_UBYTE *GPIO_BASE_B = (volatile MMP_UBYTE *)0x80009400;  return GPIO_BASE_B[0xB0];*/}


static MMP_UBYTE GetAFEnable_S5K4B2FX(void)
{
    //return 0;
    return ISP_IF_AF_GetResult();
}

static MMP_UBYTE GetExposureValue_S5K4B2FX  (void){return ISP_IF_AE_GetEV();}
static MMP_UBYTE GetAEsmooth_S5K4B2FX       (void){return 0;}
...
MMPF_SENSOR_FUNCTION  SensorFunction_S5K4B2FX =
{
    MMPF_Sensor_Initialize_S5K4B2FX,
    MMPF_Sensor_InitializeVIF_S5K4B2FX,
    MMPF_Sensor_InitializeISP_S5K4B2FX,
    MMPF_Sensor_PowerDown_S5K4B2FX,
    MMPF_Sensor_SetFrameRate_S5K4B2FX,
    MMPF_Sensor_ChangeMode_S5K4B2FX,
    MMPF_Sensor_ChangePreviewMode_S5K4B2FX,
    MMPF_Sensor_SetPreviewMode_S5K4B2FX,
    MMPF_Sensor_SetReg_S5K4B2FX,
    MMPF_Sensor_GetReg_S5K4B2FX,
    MMPF_Sensor_Do3AOperation_S5K4B2FX,
    MMPF_Sensor_DoAFOperation_S5K4B2FX,
    MMPF_Sensor_DoIQOperation_S5K4B2FX,
    MMPF_Sensor_SetImageEffect_S5K4B2FX,
    MMPF_SetLightFreq_S5K4B2FX,
    MMPF_SetStableState_S5K4B2FX,
    MMPF_SetHistEQState_S5K4B2FX,
    MMPF_Sensor_SetAFPosition_S5K4B2FX,
    SetAFWin_S5K4B2FX,
    SetAFEnable_S5K4B2FX,
    MMPF_Sensor_SetAEEnable_S5K4B2FX,
    MMPF_Sensor_SetAWBEnable_S5K4B2FX,
    MMPF_Sensor_SetExposureValue_S5K4B2FX,
    SetAEsmooth_S5K4B2FX,
    MMPF_Sensor_SetImageScene_S5K4B2FX,
    GetAFPosition_S5K4B2FX,
    GetAFEnable_S5K4B2FX,
    GetExposureValue_S5K4B2FX,
    GetAEsmooth_S5K4B2FX,
    MMPF_Sensor_SetAWBType_S5K4B2FX,
    MMPF_Sensor_SetContrast_S5K4B2FX,
    MMPF_Sensor_SetSaturation_S5K4B2FX,
    MMPF_Sensor_SetSharpness_S5K4B2FX,
    MMPF_Sensor_SetHue_S5K4B2FX,
    MMPF_Sensor_SetGamma_S5K4B2FX,
    MMPF_Sensor_SetBacklight_S5K4B2FX,
    MMPF_Sensor_SetAEMode_S5K4B2FX,
    MMPF_Sensor_SetAFMode_S5K4B2FX,    
    MMPF_Sensor_SetCaptureISPSetting_S5K4B2FX,
    MMPF_Sensor_SetISPWindow_S5K4B2FX,
    MMPF_Sensor_CheckPreviewAbility_S5K4B2FX
};

#if (SENSOR_ID_S5K4B2FX== 0)
MMPF_SENSOR_FUNCTION  *SensorFunction_Module0 = &SensorFunction_S5K4B2FX;
#endif

#if (SENSOR_ID_S5K4B2FX== 1)
MMPF_SENSOR_FUNCTION  *SensorFunction_Module1 = &SensorFunction_S5K4B2FX;
#endif

#endif  //BIND_SENSOR_S5K4B2FX
#endif
