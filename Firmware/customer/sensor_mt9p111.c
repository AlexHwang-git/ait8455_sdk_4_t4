...
//#include "motor_ctl.h"
//------------------------------------------------------------------------------
//  Function    : MT9P111_Sensor_PreviewMode
//  Description :
//------------------------------------------------------------------------------
static void MT9P111_Sensor_SetResolution(ISP_SENSOR_RESOL resol)	// Patrick add
{
...
static void MT9P111_Sensor_PreviewMode(MMP_USHORT usPreviewmode, MMP_USHORT usPhasecount)
{
    ...
    case 0:
		...
		MT9P111_Sensor_SetResolution(ISP_SENSOR_RESOL_2560x1920);
    ...
    case 1:
        ...
        case SENSOR_VIDEO_MODE:
			...
			MT9P111_Sensor_SetResolution(ISP_SENSOR_RESOL_1280x960);
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_Initialize_MT9P111(void)
{
//  MMP_USHORT usData;
    ...
    RTNA_DBG_Str(0, "MMPF_Sensor_Initialize_MT9P111...Begin\r\n");
...
//    pGPIO->GPIO_DATA[0] &= ~(1 << AF_EN);  // Turn On Motor
    ...
    RTNA_DBG_Str(3, "MMPF_Sensor_Initialize_MT9P111...End\r\n");
    return  MMP_ERR_NONE;
}

//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_PowerDown_MT9P111
//  Description :
//------------------------------------------------------------------------------

static MMP_ERR  MMPF_Sensor_PowerDown_MT9P111(void)
{
    AITPS_VIF  pVIF = AITC_BASE_VIF;
    AITPS_GPIO  pGPIO = AITC_BASE_GPIO;
    ...
    RTNA_DBG_Str3( "MMPF_Sensor_PowerDown_MT9P111() \r\n");

    return  MMP_ERR_NONE;
}

//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_SetFrameRate_MT9P111
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_SetFrameRate_MT9P111(MMP_UBYTE ubFrameRate)
{
    return  MMP_ERR_NONE;
}
...
static MMP_ERR MMPF_Sensor_SetPreviewMode_MT9P111(MMP_USHORT usPreviewmode, MMP_USHORT usPhasecount)
{
    MT9P111_Sensor_PreviewMode(usPreviewmode, usPhasecount);
...
static MMP_ERR MMPF_Sensor_ChangePreviewMode_MT9P111(
                        MMP_USHORT usCurPreviewmode, MMP_USHORT usCurPhasecount,
                        MMP_USHORT usNewPreviewmode, MMP_USHORT usNewPhasecount)
{
    MT9P111_Sensor_PreviewMode(usNewPreviewmode, usNewPhasecount);
...
static MMP_ERR MMPF_Sensor_ChangeMode_MT9P111(MMP_USHORT usPreviewmode, MMP_USHORT usCapturemode)
{
    switch (usPreviewmode) {
    case 0:
    ...
    case 1:
        ...
        case 0:// SXGA preview, 5M capture
            MMPF_Sensor_SetPreviewMode_MT9P111(0, 0);
            // wait 3 frame ...
            MMPF_Sensor_WaitFrame(5);
            break;
        case 1:
            MMPF_Sensor_SetPreviewMode_MT9P111(1, 0);
            // wait 3 frame ...
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_InitializeVIF_MT9P111(void)
{
    AITPS_MIPI  pMIPI = AITC_BASE_MIPI;
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_InitializeISP_MT9P111(void)
{
    return  MMP_ERR_NONE;
}
...
//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_SetAFPosition_MT9P111
//  Description :
// ---------------------------------------
static MMP_ERR MMPF_Sensor_SetAFPosition_MT9P111(MMP_UBYTE ubPos)
{
#if 1
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_Do3AOperation_MT9P111(void)
{
	ISP_IF_R_GetAEAcc();
	ISP_IF_R_GetAWBAcc();
	//ISP_IF_R_Do3A();
    ...
    //RTNA_DBG_Str(0, "Do3AOperation_MT9P111()\r\n");
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_DoAFOperation_MT9P111(void)
{
#if SUPPORT_AUTO_FOCUS
...
//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_DoIQOperation_MT9P111
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_Sensor_DoIQOperation_MT9P111(void)
{
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR  MMPF_SetLightFreq_MT9P111(MMP_USHORT usMode)
{
...
static MMP_ERR  MMPF_SetStableState_MT9P111(MMP_BOOL bStableState)
{
    return  MMP_ERR_NONE;
}

MMP_ERR MMPF_SetHistEQState_MT9P111(MMP_BOOL bHistEQState)
{

    return  MMP_ERR_NONE;
}

static MMP_ERR  MMPF_Sensor_SetReg_MT9P111(MMP_USHORT usAddr, MMP_USHORT usData)
{
    MMPF_I2cm_WriteReg(usAddr, usData);
    return  MMP_ERR_NONE;
}

static MMP_ERR  MMPF_Sensor_GetReg_MT9P111(MMP_USHORT usAddr, MMP_USHORT *usData)
{
...
static MMP_ERR  MMPF_Sensor_SetImageScene_MT9P111(MMP_USHORT imgSceneID)
{
/*
typedef enum {
...
*/
	...
	RTNA_DBG_Str(3, "MMPF_SetImageScene_MT9P111 : ");
...
static MMP_ERR  MMPF_Sensor_SetAEMode_MT9P111(MMP_UBYTE ubAEMode, MMP_UBYTE ubISOMode)
{
/*
typedef enum {
	AE_MODE_AUTO						= 0,
...
*/
	RTNA_DBG_Str(3, "MMPF_Sensor_SetAEMode_MT9P111 : ");
...
static MMP_ERR  MMPF_Sensor_SetAFMode_MT9P111(MMP_UBYTE ubAFMode)
{
/*
typedef enum {
...
*/
	RTNA_DBG_Str(3, "MMPF_Sensor_SetAFMode_MT9P111 : ");
...
// description :                                                        //
//======================================================================//
static MMP_ERR  MMPF_Sensor_SetImageEffect_MT9P111(MMP_USHORT imgEffectID)
{
/*
typedef enum {
...
*/
	...
	RTNA_DBG_Str(3, "MMPF_Sensor_SetImageEffect_MT9P111 : ");
...
static MMP_ERR  MMPF_Sensor_SetAWBType_MT9P111(MMP_UBYTE ubType)
{
#if 0
	RTNA_DBG_Str(3, "MMPF_Sensor_SetAWBType_MT9P111 : ");
...
static MMP_ERR  MMPF_Sensor_SetContrast_MT9P111(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_Contrast_MT9P111 : ");
...
static MMP_ERR  MMPF_Sensor_SetSaturation_MT9P111(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetSaturation_MT9P111 : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetSharpness_MT9P111(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetSharpness_MT9P111 : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetHue_MT9P111(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetHue_MT9P111 : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetGamma_MT9P111(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetGamma_MT9P111 : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetBacklight_MT9P111(MMP_UBYTE ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetBacklight_MT9P111 : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static void  MMPF_Sensor_SetCaptureISPSetting_MT9P111(MMP_UBYTE usCaptureBegin)
{
    AITPS_VIF  pVIF = AITC_BASE_VIF;
...
static void  MMPF_Sensor_SetISPWindow_MT9P111(MMP_ULONG ulWidth, MMP_ULONG ulHeight)
{
...
static MMP_UBYTE  MMPF_Sensor_CheckPreviewAbility_MT9P111(MMP_USHORT usPreviewmode)
{
    switch(usPreviewmode){
...
static void SetAFWin_MT9P111(MMP_USHORT usIndex, MMP_USHORT usPreviewWidth, MMP_USHORT usPreviewHeight,
...
static void SetAFEnable_MT9P111(MMP_UBYTE enable)
{
//    if (enable) {
        RTNA_DBG_Str(3, "VENUS_ISP_AUTO_FOCUS_STATUS_START\r\n");
        ISP_IF_AF_Control(ISP_AF_START);
        //actually calling SNR_MT9P111_SetAutoFocusControl()
//    } else {
...
static MMP_ERR MMPF_Sensor_SetAEEnable_MT9P111(MMP_UBYTE bEnable)  
{
	/*
	if (bEnable) {
...
static MMP_ERR MMPF_Sensor_SetAWBEnable_MT9P111(MMP_UBYTE bEnable) 
{
#if 0
	if (bEnable) {
...
static void SetAEsmooth_MT9P111(MMP_UBYTE smooth)  {return;}
static MMP_ERR MMPF_Sensor_SetExposureValue_MT9P111(MMP_UBYTE ev)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetExposureValue_MT9P111 : ");
...
static MMP_UBYTE GetAFPosition_MT9P111     (void){ return 0;/*volatile MMP_UBYTE *GPIO_BASE_B = (volatile MMP_UBYTE *)0x80009400;  return GPIO_BASE_B[0xB0];*/}


static MMP_UBYTE GetAFEnable_MT9P111(void)
{
    //return 0;
    return ISP_IF_AF_GetResult();
}

static MMP_UBYTE GetExposureValue_MT9P111  (void){return ISP_IF_AE_GetEV();}
static MMP_UBYTE GetAEsmooth_MT9P111       (void){return 0;}
...
MMPF_SENSOR_FUNCTION  SensorFunction_MT9P111 =
{
    MMPF_Sensor_Initialize_MT9P111,
    MMPF_Sensor_InitializeVIF_MT9P111,
    MMPF_Sensor_InitializeISP_MT9P111,
    MMPF_Sensor_PowerDown_MT9P111,
    MMPF_Sensor_SetFrameRate_MT9P111,
    MMPF_Sensor_ChangeMode_MT9P111,
    MMPF_Sensor_ChangePreviewMode_MT9P111,
    MMPF_Sensor_SetPreviewMode_MT9P111,
    MMPF_Sensor_SetReg_MT9P111,
    MMPF_Sensor_GetReg_MT9P111,
    MMPF_Sensor_Do3AOperation_MT9P111,
    MMPF_Sensor_DoAFOperation_MT9P111,
    MMPF_Sensor_DoIQOperation_MT9P111,
    MMPF_Sensor_SetImageEffect_MT9P111,
    MMPF_SetLightFreq_MT9P111,
    MMPF_SetStableState_MT9P111,
    MMPF_SetHistEQState_MT9P111,
    MMPF_Sensor_SetAFPosition_MT9P111,
    SetAFWin_MT9P111,
    SetAFEnable_MT9P111,
    MMPF_Sensor_SetAEEnable_MT9P111,
    MMPF_Sensor_SetAWBEnable_MT9P111,
    MMPF_Sensor_SetExposureValue_MT9P111,
    SetAEsmooth_MT9P111,
    MMPF_Sensor_SetImageScene_MT9P111,
    GetAFPosition_MT9P111,
    GetAFEnable_MT9P111,
    GetExposureValue_MT9P111,
    GetAEsmooth_MT9P111,
    MMPF_Sensor_SetAWBType_MT9P111,
    MMPF_Sensor_SetContrast_MT9P111,
    MMPF_Sensor_SetSaturation_MT9P111,
    MMPF_Sensor_SetSharpness_MT9P111,
    MMPF_Sensor_SetHue_MT9P111,
    MMPF_Sensor_SetGamma_MT9P111,
    MMPF_Sensor_SetBacklight_MT9P111,
    MMPF_Sensor_SetAEMode_MT9P111,
    MMPF_Sensor_SetAFMode_MT9P111,    
    MMPF_Sensor_SetCaptureISPSetting_MT9P111,
    MMPF_Sensor_SetISPWindow_MT9P111,
    MMPF_Sensor_CheckPreviewAbility_MT9P111
};

#if (SENSOR_ID_MT9P111== 0)
MMPF_SENSOR_FUNCTION  *SensorFunction_Module0 = &SensorFunction_MT9P111;
#endif

#if (SENSOR_ID_MT9P111== 1)
MMPF_SENSOR_FUNCTION  *SensorFunction_Module1 = &SensorFunction_MT9P111;
#endif

#endif  //BIND_SENSOR_MT9P111
#endif
