//==============================================================================
//
//  File        : sensor_IMX046TS.c
//  Description : Firmware Dispplay Control API function
...
//#include "IMX046TS.h"
//------------------------------------------------------------------------------
//  Function    : IMX046TS_Sensor_SetResolution
//  Description :
//------------------------------------------------------------------------------
static void IMX046TS_Sensor_SetResolution(ISP_SENSOR_RESOL resol)	// Patrick add
{
...
//------------------------------------------------------------------------------
//  Function    : IMX046TS_Sensor_PreviewMode
//  Description :
//------------------------------------------------------------------------------

static void	IMX046TS_Sensor_PreviewMode(MMP_USHORT usPreviewmode, MMP_USHORT usPhasecount)
{
	...
	case 1:
		...
		case SENSOR_VIDEO_MODE:
			...
			IMX046TS_Sensor_SetResolution(ISP_SENSOR_RESOL_1600x1200);
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR	MMPF_Sensor_Initialize_IMX046TS(void)
{
//	MMP_USHORT usData;
#if (CHIP == D_V1)
	...
	RTNA_DBG_Str(0, "MMPF_Sensor_Initialize_IMX046TS...Begin\r\n");

    //Init globol variable used by DSC
    gsSensorLCModeWidth 	= 3264;
    gsSensorLCModeHeight 	= 2448;

    gsSensorMCModeWidth 	= 1600;
    gsSensorMCModeHeight 	= 1200;
	...
	ISP_IF_SNR_Init();
	MMPF_OS_Sleep_MS(120);	//Patrick

	//VR_Motor_Init();

	RTNA_DBG_Str(3, "MMPF_Sensor_Initialize_IMX046TS...End\r\n");
	return	MMP_ERR_NONE;
}

//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_PowerDown_IMX046TS
//  Description :
//------------------------------------------------------------------------------

static MMP_ERR	MMPF_Sensor_PowerDown_IMX046TS(void)
{

//Rogers: Modify sensor power on sequence
    AITPS_VIF  pVIF = AITC_BASE_VIF;
#if (CHIP == D_V1)
    AITPS_GPIO  pGPIO = AITC_BASE_GPIO;
...
//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_SetFrameRate_IMX046TS
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR	MMPF_Sensor_SetFrameRate_IMX046TS(MMP_UBYTE ubFrameRate)
{
	return	MMP_ERR_NONE;
}
...
static MMP_ERR MMPF_Sensor_SetPreviewMode_IMX046TS(MMP_USHORT usPreviewmode, MMP_USHORT usPhasecount)
{
	IMX046TS_Sensor_PreviewMode(usPreviewmode, usPhasecount);
...
static MMP_ERR MMPF_Sensor_ChangePreviewMode_IMX046TS(
                        MMP_USHORT usCurPreviewmode, MMP_USHORT usCurPhasecount,
                        MMP_USHORT usNewPreviewmode, MMP_USHORT usNewPhasecount)
{
	IMX046TS_Sensor_PreviewMode(usNewPreviewmode, usNewPhasecount);
...
static MMP_ERR MMPF_Sensor_ChangeMode_IMX046TS(MMP_USHORT usPreviewmode, MMP_USHORT usCapturemode)
{
	switch (usPreviewmode) {
	case 0:
	...
	case 1:
        switch (usCapturemode) {
	    case 0:// VGA preview, 3M capture
        	MMPF_Sensor_SetPreviewMode_IMX046TS(0, 0);
			// wait 3 frame ...
            MMPF_Sensor_WaitFrame(5);
            break;
	    case 1:
	    	MMPF_Sensor_SetPreviewMode_IMX046TS(1, 0);
...
static MMP_ERR	MMPF_Sensor_InitializeVIF_IMX046TS(void)
{
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR	MMPF_Sensor_InitializeISP_IMX046TS(void)
{
	return	MMP_ERR_NONE;
}
...
//------------------------------------------------------------------------------
//  Function    : MMPF_Sensor_SetAFPosition_IMX046TS
//  Description :
// ---------------------------------------
static MMP_ERR	MMPF_Sensor_SetAFPosition_IMX046TS(MMP_UBYTE ubPos)
{
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR	MMPF_Sensor_Do3AOperation_IMX046TS(void)
{
	//VR_AF_GetAcc();
	ISP_IF_R_GetAEAcc();
	ISP_IF_R_GetAWBAcc();
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR	MMPF_Sensor_DoIQOperation_IMX046TS(void)
{
...
//  Description :
//------------------------------------------------------------------------------
static MMP_ERR	MMPF_SetLightFreq_IMX046TS(MMP_USHORT usMode)
{
...
static MMP_ERR	MMPF_SetStableState_IMX046TS(MMP_BOOL bStableState)
{
	return	MMP_ERR_NONE;
}

MMP_ERR	MMPF_SetHistEQState_IMX046TS(MMP_BOOL bHistEQState)
{

	return	MMP_ERR_NONE;
}

static MMP_ERR	MMPF_Sensor_SetReg_IMX046TS(MMP_USHORT usAddr, MMP_USHORT usData)
{
	MMPF_I2cm_WriteReg(usAddr, usData);
	return	MMP_ERR_NONE;
}

static MMP_ERR	MMPF_Sensor_GetReg_IMX046TS(MMP_USHORT usAddr, MMP_USHORT *usData)
{
...
static MMP_ERR	MMPF_Sensor_SetImageScene_IMX046TS(MMP_USHORT imgSceneID)
{	
/*
typedef enum {
...
static MMP_ERR  MMPF_Sensor_SetAEMode_IMX046TS(MMP_UBYTE ubAEMode, MMP_UBYTE ubISOMode)
{
/*
typedef enum {
	AE_MODE_AUTO						= 0,
...
*/
	RTNA_DBG_Str(3, "MMPF_Sensor_SetAEMode_IMX046TS : ");
...
static MMP_ERR  MMPF_Sensor_SetAFMode_IMX046TS(MMP_UBYTE ubAFMode)
{
/*
typedef enum {
...
*/
	RTNA_DBG_Str(3, "MMPF_Sensor_SetAFMode_IMX046TS : ");
...
// description : 														//
//======================================================================//
static MMP_ERR	MMPF_Sensor_SetImageEffect_IMX046TS(MMP_USHORT imgEffectID)
{
/*
typedef enum {
...
*/
	...
	RTNA_DBG_Str(3, "MMPF_SetImageEffect_IMX046TS : ");
...
static MMP_ERR  MMPF_Sensor_SetAWBType_IMX046TS(MMP_UBYTE ubType)
{
#if 0
	RTNA_DBG_Str(3, "MMPF_Sensor_SetAWBType_IMX046TS : ");
...
static MMP_ERR  MMPF_Sensor_SetContrast_IMX046TS(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_Contrast_IMX046TS : ");
...
static MMP_ERR  MMPF_Sensor_SetSaturation_IMX046TS(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetSaturation_IMX046TS : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetSharpness_IMX046TS(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetSharpness_IMX046TS : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetHue_IMX046TS(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetHue_IMX046TS : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetGamma_IMX046TS(MMP_SHORT ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetGamma_IMX046TS : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static MMP_ERR  MMPF_Sensor_SetBacklight_IMX046TS(MMP_UBYTE ubLevel)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetBacklight_IMX046TS : ");
	RTNA_DBG_Byte(3, ubLevel);
	RTNA_DBG_Str(3, "\r\n");
...
static void  MMPF_Sensor_SetCaptureISPSetting_IMX046TS(MMP_UBYTE usCaptureBegin)
{
    AITPS_VIF  pVIF = AITC_BASE_VIF;
...
static void  MMPF_Sensor_SetISPWindow_IMX046TS(MMP_ULONG ulWidth, MMP_ULONG ulHeight)
{
...
static MMP_UBYTE  MMPF_Sensor_CheckPreviewAbility_IMX046TS(MMP_USHORT usPreviewmode)
{
    switch(usPreviewmode){
        case 0:                 //8M can't preview
            return MMP_FALSE;           
            break;
        case 1:                 //2M can preview
            return MMP_TRUE;           
            break;
    }
...
static void SetAFWin_IMX046TS(MMP_USHORT usIndex, MMP_USHORT usPreviewWidth, MMP_USHORT usPreviewHeight,
...
static void SetAFEnable_IMX046TS(MMP_UBYTE enable)
{
	DBG_S3("VENUS_ISP_AUTO_FOCUS_STATUS_START\r\n");
	ISP_IF_AF_Control(ISP_AF_START);
}

static MMP_ERR MMPF_Sensor_SetAEEnable_IMX046TS(MMP_UBYTE bEnable)  
{
	/*
	if (bEnable) {
...
static MMP_ERR MMPF_Sensor_SetAWBEnable_IMX046TS(MMP_UBYTE bEnable) 
{
#if 0
	if (bEnable) {
...
static void SetAEsmooth_IMX046TS(MMP_UBYTE smooth)  { /*gbAEsmooth 	= smooth; */}
static MMP_ERR MMPF_Sensor_SetExposureValue_IMX046TS(MMP_UBYTE ev)
{
	RTNA_DBG_Str(3, "MMPF_Sensor_SetExposureValue_IMX046TS : ");
...
static MMP_UBYTE GetAFPosition_IMX046TS		(void){	return 0;/*volatile MMP_UBYTE *GPIO_BASE_B = (volatile MMP_UBYTE *)0x80009400;	return GPIO_BASE_B[0xB0];*/}


static MMP_UBYTE GetAFEnable_IMX046TS(void)
{
        //return 0;
        return ISP_IF_AF_GetResult();
}

static MMP_UBYTE GetExposureValue_IMX046TS	(void){return 0;}
static MMP_UBYTE GetAEsmooth_IMX046TS		(void){return 0; /*return gbAEsmooth; */		}
...
MMPF_SENSOR_FUNCTION  SensorFunction_IMX046TS=
{
    MMPF_Sensor_Initialize_IMX046TS,
    MMPF_Sensor_InitializeVIF_IMX046TS,
    MMPF_Sensor_InitializeISP_IMX046TS,
    MMPF_Sensor_PowerDown_IMX046TS,
    MMPF_Sensor_SetFrameRate_IMX046TS,
    MMPF_Sensor_ChangeMode_IMX046TS,
    MMPF_Sensor_ChangePreviewMode_IMX046TS,
    MMPF_Sensor_SetPreviewMode_IMX046TS,
    MMPF_Sensor_SetReg_IMX046TS,
    MMPF_Sensor_GetReg_IMX046TS,
    MMPF_Sensor_Do3AOperation_IMX046TS,
    MMPF_Sensor_DoIQOperation_IMX046TS,
    MMPF_Sensor_SetImageEffect_IMX046TS,
    MMPF_SetLightFreq_IMX046TS,
    MMPF_SetStableState_IMX046TS,
    MMPF_SetHistEQState_IMX046TS,
    MMPF_Sensor_SetAFPosition_IMX046TS,
    SetAFWin_IMX046TS,
    SetAFEnable_IMX046TS,
    MMPF_Sensor_SetAEEnable_IMX046TS,
    MMPF_Sensor_SetAWBEnable_IMX046TS,
    MMPF_Sensor_SetExposureValue_IMX046TS,
    SetAEsmooth_IMX046TS,
    MMPF_Sensor_SetImageScene_IMX046TS,
    GetAFPosition_IMX046TS,
    GetAFEnable_IMX046TS,
	GetExposureValue_IMX046TS,
	GetAEsmooth_IMX046TS,
	MMPF_Sensor_SetAWBType_IMX046TS,
	MMPF_Sensor_SetContrast_IMX046TS,
	MMPF_Sensor_SetSaturation_IMX046TS,
	MMPF_Sensor_SetSharpness_IMX046TS,
    MMPF_Sensor_SetHue_IMX046TS,
    MMPF_Sensor_SetGamma_IMX046TS,
    MMPF_Sensor_SetBacklight_IMX046TS,
    MMPF_Sensor_SetAEMode_IMX046TS,
    MMPF_Sensor_SetAFMode_IMX046TS,    	
    MMPF_Sensor_SetCaptureISPSetting_IMX046TS,
    MMPF_Sensor_SetISPWindow_IMX046TS,
    MMPF_Sensor_CheckPreviewAbility_IMX046TS
};

#if (SENSOR_ID_IMX046TS == 0)
MMPF_SENSOR_FUNCTION  *SensorFunction_Module0 = &SensorFunction_IMX046TS;
#endif

#if (SENSOR_ID_IMX046TS == 1)
MMPF_SENSOR_FUNCTION  *SensorFunction_Module1 = &SensorFunction_IMX046TS;
#endif

#endif  //BIND_SENSOR_IMX046TS
#endif
