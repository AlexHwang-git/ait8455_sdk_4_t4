...
;------------------------------------------------------------------------------
            ...
            INCLUDE   include\reg_retina.inc ; add include\ for realview
...
reset_vec        
                B           reset_vec            ; reset
undef_vec
                B           AbortCheck            ; Undefined Instruction
swi_vec
                B           AbortCheck              ; Software Interrupt
pabt_vec
                B           AbortCheck             ; Prefetch Abort
dabt_vec
                B           AbortCheck             ; Data Abort
rsvd_vec
                B           AbortCheck             ; reserved
irq_vec
                ldr         pc, [pc,#-0xF20]    ; IRQ : read the AIC
fiq_vec
                B           AbortCheck              ; FIQ
chip_mark         DCD     0x35353438
lr_reg            DCD     0xdeadbeef
sp_reg            DCD     0xdeadbeef
AbortCheck
